...
class TestHighPrecisionRoundtrip(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # Create GCToo object with high precision values, used to check that
        # writing and re-parsing GCT/GCTX files doesn't lose precision.
